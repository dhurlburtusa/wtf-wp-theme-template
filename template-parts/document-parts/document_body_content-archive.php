	...
	<div class="pg__body" id="content">
		<div class="pg__body__content">
			<main>
				...
				<p>template-parts/document-parts/document_body_content-archive.php</p>
				--->

				<?php if ( have_posts() ) : ?>
					<section class="posts-area posts-area--<?php echo WTF__PAGE_TEMPLATE_NAME; ?>">
						<h1>
							<span class="page__title"><?php the_archive_title(); ?></span>
						</h1>

						<p class="archive__description"><?php the_archive_description(); ?></p>
