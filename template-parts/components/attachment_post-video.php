<?php
/**
 * The template part for displaying a single post attachment with `video`
 * mime-type.
 *
 * @package WordPress
 * @subpackage WTF
...
<p>template-parts/components/attachment_post-video.php</p>
...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="entry__content">
		<div class="entry__attachment">
			<?php
			wtf__the_video_attachment();
			wtf__the_excerpt( 'entry__caption' );
			?>
		</div><!-- .entry__attachment -->

		<?php
		// TODO: Determine whether calling `the_content` is ever necessary for a video
