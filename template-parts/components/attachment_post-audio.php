<?php
/**
 * The template part for displaying a single post attachment with `audio`
 * mime-type.
 *
 * @package WordPress
 * @subpackage WTF
...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="entry__content">
		<div class="entry__attachment">
			<?php
			wtf__the_audio_attachment();
			wtf__the_excerpt( 'entry__caption' );
			?>
		</div><!-- .entry__attachment -->

		<?php
		// TODO: Determine whether calling `the_content` is ever necessary for an audio
