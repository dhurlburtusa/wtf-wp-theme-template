<?php
/**
 * The template part for displaying the content of a post of type `{post_type}`.
 *
 * @package WordPress
 * @subpackage WTF
...
<!---
<p>template-parts/post-parts/post_content-{post_type}.php</p>
--->
...
$wtf__component_post_post_tpl_slug = apply_filters( 'wtf__component_post_post_tpl_slug', '{post_type}_post');
